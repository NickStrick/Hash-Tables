...
# size of it and protection from goin past that
# size of objects
# to append need StopAsyncIterationtrack allocated and used
# if w erun out of space, we need to make a new one with more space
